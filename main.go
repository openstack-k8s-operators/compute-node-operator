...
func init() {
	...
	utilruntime.Must(performancev1alpha1.SchemeBuilder.AddToScheme(scheme))
...
func main() {
	...
	if err = (&controllers.ComputeNodeOpenStackReconciler{
		Client:  mgr.GetClient(),
		Kclient: kclient,
		Log:     ctrl.Log.WithName("controllers").WithName("ComputeNodeOpenStack"),
		Scheme:  mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ComputeNodeOpenStack")
		os.Exit(1)
	}
