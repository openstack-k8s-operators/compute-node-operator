...
func (in *ComputeNodeOpenStackStatus) DeepCopyInto(out *ComputeNodeOpenStackStatus) {
	*out = *in
	...
	if in.DisabledNodes != nil {
		in, out := &in.DisabledNodes, &out.DisabledNodes
		*out = make([]DisabledNode, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DisabledNode) DeepCopyInto(out *DisabledNode) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DisabledNode.
func (in *DisabledNode) DeepCopy() *DisabledNode {
	if in == nil {
		return nil
	}
	out := new(DisabledNode)
	in.DeepCopyInto(out)
	return out
}
